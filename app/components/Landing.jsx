...
const projects = [
  ...
  },
  {
    ...
    subheading: "FUSION",
    description:
      "One of the main problems we faced is a poor user interface that made people struggle on some steps. On top of that, we noticed que there were some unnecessary steps that could be removed.",
